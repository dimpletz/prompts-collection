...
- If companion scripts were required, they have already been saved under the same skill directory (`.../skills/<skill-name>/scripts/`), not at plugin-level scripts paths.
