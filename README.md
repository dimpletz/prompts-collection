...
| [ai-engineer](plugins/ai-engineer/) | `SessionStart`, `SubagentStart` | Injects guidance to always consider temporary shell/PowerShell scripts when handling large files, and to delete those temporary scripts after use. |
