...
| [learner](plugins/learner/) `v1.0.0` | Agents for capturing and organising personal study notes by topic in structured Markdown files with sections, Mermaid diagrams, and a table of contents. | [Topic Scriber](plugins/learner/agents/TopicScriber.agent.md) | — | — |
