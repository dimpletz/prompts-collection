...
| [makers](plugins/makers/) `v1.1.0` | Skills for creating and optimizing VS Code agents, skills, and custom instruction files. | — | [Agent Maker](plugins/makers/skills/agent-maker/SKILL.md), [Agent Optimizer](plugins/makers/skills/agent-optimizer/SKILL.md), [Custom Instruction Maker](plugins/makers/skills/custom-instruction-maker/SKILL.md), [Skill Maker](plugins/makers/skills/skill-maker/SKILL.md) |
...
| [Custom Instruction Maker](plugins/makers/skills/custom-instruction-maker/SKILL.md) | makers | Creates structured AI instruction files (`AGENTS.md`, `copilot-instructions.md`, `CLAUDE.md`) following the Purpose → Tree → Rules structure with a built-in self-improving note-taking engine. |
