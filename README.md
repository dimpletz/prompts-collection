...
| [git-manager](plugins/git-manager/) `v1.1.0` | Skills for managing Git repositories, worktrees, merge conflicts, and pull requests. | — | [Git Merge Conflict Resolver](plugins/git-manager/skills/git-merge-conflict-resolver/SKILL.md), [Git Worktree Manager](plugins/git-manager/skills/git-worktree-manager/SKILL.md), [PR Cloner](plugins/git-manager/skills/pr-cloner/SKILL.md), [Git Merge Auditor](plugins/git-manager/skills/git-merge-auditor/SKILL.md) |
