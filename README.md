...
| [ai-engineer](plugins/ai-engineer/) | `SessionStart`, `SubagentStart` | Injects guidance to use direct commands for simple file handling (including large files when handling is simple), and use temporary shell/PowerShell scripts for large, complex file handling. Temporary scripts should be deleted after use. |
