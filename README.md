...
| [git-manager](plugins/git-manager/) `v1.4.0` | Skills for managing Git repositories, worktrees, merge conflicts, pull requests, diff generation, and text normalization. | — | [Git Merge Conflict Resolver](plugins/git-manager/skills/git-merge-conflict-resolver/SKILL.md), [Git Worktree Manager](plugins/git-manager/skills/git-worktree-manager/SKILL.md), [Git PR Cloner](plugins/git-manager/skills/git-pr-cloner/SKILL.md), [Git Merge Auditor](plugins/git-manager/skills/git-merge-auditor/SKILL.md), [Git Diff Generator](plugins/git-manager/skills/git-diff-generator/SKILL.md), [Encoding Normalizer](plugins/git-manager/skills/encoding-normalizer/SKILL.md) | `SessionStart`, `SubagentStart` |
...
| [Git Diff Generator](plugins/git-manager/skills/git-diff-generator/SKILL.md) | git-manager | Generates a `.diff` file for whole-branch, PR, remote-branch, commit-range, single-commit, first-commit, and staged-file workflows. Saves to `GIT_DIFF_DIR` when available, otherwise to the workspace root. |
| [Encoding Normalizer](plugins/git-manager/skills/encoding-normalizer/SKILL.md) | git-manager | Normalizes tracked text files when the diff is caused only by line-ending churn or mixed encodings. Restores line-ending-only changes from Git and reuses the previous committed encoding for mixed-encoding fixes. |
