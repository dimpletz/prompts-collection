...
| [ai-engineer](plugins/ai-engineer/) | `SessionStart`, `SubagentStart` | Injects guidance to use direct commands for simple tasks, and use temporary shell/PowerShell scripts for large or complex file handling. Temporary scripts should be deleted after use. |
