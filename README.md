...
| [ai-engineer](plugins/ai-engineer/) `v1.1.0` | Skills for creating and optimizing VS Code agents, skills, and custom instruction files. | — | [Agent Maker](plugins/ai-engineer/skills/agent-maker/SKILL.md), [Agent Optimizer](plugins/ai-engineer/skills/agent-optimizer/SKILL.md), [Custom Instruction Maker](plugins/ai-engineer/skills/custom-instruction-maker/SKILL.md), [Skill Maker](plugins/ai-engineer/skills/skill-maker/SKILL.md) | — |
...
| [Git Diff Generator](plugins/git-manager/skills/git-diff-generator/SKILL.md) | git-manager | Generates a `.diff` file comparing a source (PR ID, current local branch, or remote branch) against a target branch using three-dot diff semantics. Saves to `GIT_DIFF_DIR` when available, otherwise to the workspace root. |
