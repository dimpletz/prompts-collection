...
| [ai-engineer](plugins/ai-engineer/) | `SessionStart`, `SubagentStart` | Injects guidance to use direct commands for simple file handling, and use temporary shell/PowerShell scripts for large file handling. Temporary scripts should be deleted after use. |
